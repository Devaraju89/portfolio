...
const ProjectCard = ({ project, aosDelay }) => (
  ...
  >
    <div className={`rounded-2xl p-6 md:p-8 h-full backdrop-blur-md transition-all duration-500 flex flex-col lg:flex-row gap-8 items-center ${
      project.isFlagship 
      ...
      {/* Right / Image Preview */}
      {project.image && (
        <div className="w-full lg:w-[320px] xl:w-[380px] shrink-0 aspect-[16/10] overflow-hidden rounded-xl bg-black/40 border border-white/10 group-hover:border-red-500/40 transition-all duration-500">
          <img 
            src={project.image} 
            alt={project.title}
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20">
          ...
          <p className="text-white/50 text-base md:text-lg max-w-lg font-medium leading-relaxed">
            A selection of UI/UX design and frontend projects that showcase intuitive user flows and modern visual design.
          </p>
        </div>
